// find the ceil value from a binary search tree for a given value.
...
{        
    ...
    public:
        ...
        int ceil(Node *root, int key)
        {
            ...
            return 0;   // returning 0 because hackerrank compiler makes it mandatory to return a value regardless of presence of any conditions
        }    
};
...
int main() 
{
    ...
    int givenValue = 2;
    int ceilValue = tree.ceil(root, givenValue); // 
    cout << ceilValue;
    return 0;
}
